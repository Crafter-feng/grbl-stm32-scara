...
#ifdef SERVO_PEN
    settings.pen_top = DEFAULT_PEN_TOP;
    settings.pen_button = DEFAULT_PEN_BUTTON;
#endif
...
#else
      case 30: settings.pen_top = value; spindle_set_speed(0); break;
      case 31: settings.pen_button = value; spindle_set_speed(1); break;
#endif
      case 32:
